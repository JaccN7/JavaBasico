package sesion6refactoring.magicnumbers.good;

/**
 *
 * Método de refactorización MAGIC NUMBERS
 *
 */
...
public class Main {
    ...
    private static double calculateShipping(double price){
        return price < PRECIO_MINIMO_COMPRA ? PRECIO_ENVIO : ENVIO_GRATIS; // Hard code
    }

    private static double calculateDiscount(double price){return price * DESCUENTO;}
